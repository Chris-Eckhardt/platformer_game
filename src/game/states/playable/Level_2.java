...
public class Level_2 extends GameState {
    ...
    public void init() {
        ...
        tileMap.loadMap("/maps/level_2.txt");
    ...
    public void update() {
        ...
        if(hero.nextLevel()) {
            gsm.setState(GameStateManager.level_3, hero.getHealth(), hero.getLives());
            return;
        }
    ...
    private void populateEnemies() {
        ...
        fox1.setPosition(902, 465);
        enemies.add(fox1);

        Fox fox2 = new Fox(tileMap);
        fox2.setPosition(1693, 561);
        enemies.add(fox2);

        Fox fox3 = new Fox(tileMap);
        fox3.setPosition(1818, 561);
        enemies.add(fox3);

        Fox fox4 = new Fox(tileMap);
        fox4.setPosition(1864, 561);
        enemies.add(fox4);
    }
    ...
    private void populateHealth() {
        ...
        h1.setPosition(726, 177);
        healthList.add(h1);

        Health h2 = new Health(tileMap);
        h2.setPosition(1405, 230);
        healthList.add(h2);
